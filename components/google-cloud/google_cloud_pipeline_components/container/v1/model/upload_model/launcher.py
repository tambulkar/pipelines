...
"""GCP launcher for Upload Model based on the AI Platform SDK."""
...
from google_cloud_pipeline_components.container.v1.model.upload_model import remote_runner
